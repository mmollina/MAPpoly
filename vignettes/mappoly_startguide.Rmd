...
knitr::include_graphics(here("vignettes/images/fig1.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig2.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig3.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig4.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig5.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig6.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig7.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig8.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig9.png"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig10.png"))
```
...
```{r, eval=FALSE}
export_map_list(lg1.map.up, file = here("vignettes/images/output_file.csv"))
```
...
```
```{r, echo=FALSE, eval = TRUE, out.width = '60%'}
knitr::include_graphics(here("vignettes/images/fig11.png"))
```
