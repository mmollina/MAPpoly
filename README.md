...
The mapping strategy uses pairwise recombination fraction estimation as the first source of information to position allelic variants in specific homologs sequentially. The algorithm relies on the multilocus likelihood obtained through a hidden Markov model (HMM) for situations where pairwise analysis has limited power. The derivation of the HMM used in MAPpoly can be found in [Mollinari and Garcia, 2019](https://doi.org/10.1534/g3.119.400378). The computation of the offspring's genotypes probabilities and haplotype reconstruction, as well as the preferential pairing profiles, is presented in [Mollinari et al., 2020](https://doi.org/10.1534/g3.119.400620).
...
1.	Rose Rosette Disease Resistance Loci Detected in Two Interconnected Tetraploid Garden Rose Populations ([Lau et al., 2022](https://doi.org/10.3389%2Ffpls.2022.916231))
2.	VIEWpoly: a visualization tool to integrate and explore results of polyploid genetic analysis. ([Taniguti et al., 2022](https://doi.org/10.21105/joss.04242))
3.	Genetic Dissection of Early Blight Resistance in Tetraploid Potato. ([Xue et al., 2022](https://doi.org/10.3389/fpls.2022.851538))
4.	Haplotype reconstruction in connected tetraploid F1 populations ([Zheng et al., 2021](https://doi.org/10.1093/genetics/iyab106))
5.	QTL mapping in outbred tetraploid (and diploid) diallel populations ([Amadeu et al., 2021](https://doi.org/10.1093/genetics/iyab124))
6.	Using probabilistic genotypes in linkage analysis of polyploids. ([Liao et al., 2021](https://doi.org/10.1007/s00122-021-03834-x))
7.	Discovery of a major QTL for root-knot nematode *Meloidogyne incognita* resistance in cultivated sweetpotato *Ipomoea batatas*. ([Oloka, et al., 2021](https://doi.org/10.1007/s00122-021-03797-z))
8.	Quantitative trait locus mapping for common scab resistance in a tetraploid potato full-sib population. ([Pereira et al., 2021](https://doi.org/10.1094/PDIS-10-20-2270-RE))
9.	The recombination landscape and multiple QTL mapping in a Solanum tuberosum cv.'Atlantic'-derived F1 population. ([Pereira et al., 2021](https://doi.org/10.1101/2020.08.24.265397))
10.	High-Resolution Linkage Map and QTL Analyses of Fruit Firmness in Autotetraploid Blueberry ([Cappai et al., 2020](https://doi.org/10.3389/fpls.2020.562171))
11.	When a phenotype is not the genotype: Implications of phenotype misclassification and pedigree errors in genomics-assisted breeding of sweetpotato *Ipomoea batatas* (L.) Lam.([Gemenet et al., 2020](https://doi.org/10.1101/747469 ))
12.	Quantitative trait loci and differential gene expression analyses reveal the genetic basis for negatively associated beta-carotene and starch content in hexaploid sweetpotato [*Ipomoea batatas* (L.) Lam.] ([Gemenet et al., 2020](https://doi.org/10.1007/s00122-019-03437-7))
13.	Multiple QTL Mapping in Autopolyploids: A Random-Effect Model Approach with Application in a Hexaploid Sweetpotato Full-Sib Population. ([Pereira et al., 2020](https://doi.org/10.1534/genetics.120.303080))
...
<div class="horizontalgap" style="width:5px">
     <a id="USDA-NIFA" href="https://portal.nifa.usda.gov/web/crisprojectpages/1027948-a-genetics-based-data-analysis-system-for-breeders-in-polyploid-breeding-programs.html"><img src="nifa-color-lockup-4x.png" width="700" alt=""/></a> 
