...
RcppExport SEXP mrk_lod_hmm(SEXP ploidyR,
                            SEXP genoR,
                            SEXP phPR,
                            SEXP phQR,
                            SEXP rfR)
{
  ...
  int n_mrk = geno.ncol(); // markers are arranged in columns
  int n_ind = geno.nrow(); // individuals are arranged in rows
  int count = 0;
