...
RcppExport SEXP pairwise_rf_estimation_disc_rcpp(SEXP mrk_pairs_R, SEXP m_R, SEXP geno_R, SEXP dP_R, SEXP dQ_R, SEXP count_vector_R, SEXP count_matrix_rownames_R, SEXP count_matrix_number_R, SEXP count_matrix_pos_R, SEXP count_matrix_length_R, SEXP tol_R, SEXP threads_R);
RcppExport SEXP _mappoly_pairwise_rf_estimation_disc_rcpp(SEXP mrk_pairs_RSEXP, SEXP m_RSEXP, SEXP geno_RSEXP, SEXP dP_RSEXP, SEXP dQ_RSEXP, SEXP count_vector_RSEXP, SEXP count_matrix_rownames_RSEXP, SEXP count_matrix_number_RSEXP, SEXP count_matrix_pos_RSEXP, SEXP count_matrix_length_RSEXP, SEXP tol_RSEXP, SEXP threads_RSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(pairwise_rf_estimation_disc_rcpp(mrk_pairs_R, m_R, geno_R, dP_R, dQ_R, count_vector_R, count_matrix_rownames_R, count_matrix_number_R, count_matrix_pos_R, count_matrix_length_R, tol_R, threads_R));
...
static const R_CallMethodDef CallEntries[] = {
    {"_mappoly_pairwise_rf_estimation_disc_rcpp", (DL_FUNC) &_mappoly_pairwise_rf_estimation_disc_rcpp, 12},
